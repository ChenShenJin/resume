...
Letters.prototype = {
    ...
    initAlphabet: function(weight, rounded){
        ...
        var lineZ = 'm 0 '+ ((height / 1) - 29.3) +' l '+ width +' 0 ';
        ...
        this.alphabet = {
            ...
            'd': {
                svg: svgSmall,
                paths: [circleCenter, lineRight],
                initial: [{begin: '125%', end: '145%'}, {begin: '5%', end: '5%'}],
                final: [{begin: '20%', end: '145%'}, {begin: p50minus35, end: p50plus23}]
            },
            'e': {
                svg: svgSmall,
                paths: [circleCenter, lineE],
                initial: [{begin: '-105%', end: '-105%'}, {begin: '5%', end: '5%'}],
                final: [{begin: '35%', end: '125% + 1'}, {begin: '25%', end: p50plus23}]
            },
            'f': {
                svg: svgFJRT,
            ...
            'l': {
                svg: {width: (width - (2 * radius)), height: height},
                paths: [lineCenter],
                initial: [{begin: '30%', end: '35%'}],
                final: [{begin: '30%', end: '40%'}]
            },
            'm': {
                svg: svgLarge,
            ...
            'n': {
                svg: svgSmall,
                paths: [circleCenter, lineLeft, lineRight],
                initial: [{begin: '-60%', end: '-60%'},{begin: '-60%', end: '-60%'}, {begin: '0%', end: '60%'}],
                final: [{begin: '-25%', end: '25%'}, {begin: p50minus23, end: p50plus23}, {begin: '50%', end: '70%'} ]
            },
            'o': {
                svg: svgSmall,
                paths: [circleCenter],
            ...
            'z': {
                svg: svgSXZ,
                paths: [lineT, circleSXZ, circleSXZ2, lineZ],
                initial: [{begin: '25%', end: '25%'}, {begin: '50%', end: '50%'}, {begin: '1', end: '1'}, {begin: '5%', end: '5%'}],
                final: [{begin: p50minus20, end: '100%'}, {begin: '25%', end: '50%'}, {begin: '-25% - 1', end: '1'}, {begin: '5%', end: '95%'}]
